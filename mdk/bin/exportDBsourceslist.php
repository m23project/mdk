...
else
{
	...
	$allowedNames = array("unstable", "sid", "testing", "lucid", "imaging", "lenny", "Linux Mint 9 KDE", "HS-Fedora14", "HS-opensuse11.4", "squeeze", "squeeze+libreoffice", "HS-centos62", "precise", "precise+Xorg-updates", "Linux Mint 13 Maya");
}
